...
class UpdateDressState extends State<UpdateDress>{
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: (){
                          setState(() {
                            ...
                            updateButtonPressed(dressNotifier);
                          });
                        },
                      ),
                    ),
  ...
  void updateButtonPressed(DressNotifier dressNotifier) {
    if(selectedDress.dressPhoto==null || selectedDress.dressPhoto==""){
      selectedDress.dressPhoto= 'https://d30celkwnl03x3.cloudfront.net/blog/wp-content/uploads/2019/06/ezgif.com-gif-maker.gif?raw=true';
    }
    dressNotifier.update(selectedDress.id,selectedDress.dressCode,selectedDress.dressName,selectedDress.dressSize,selectedDress.dressPrice,selectedDress.dressColour,selectedDress.dressQuantity,selectedDress.tailoringTime,selectedDress.dressDescription,selectedDress.dressPhoto);
    Navigator.pop(context);
