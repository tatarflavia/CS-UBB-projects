...
class AddDressState extends State<AddDress>{
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: (){
                          setState(() {
                            ...
                            addButtonPressed(dressNotifier);
                          });
                        },
                      ),
                    ),
  ...
  void addButtonPressed(DressNotifier dressNotifier){
    ...
    Navigator.pop(context);
    if(dressPhoto==null || dressPhoto==""){
      dressPhoto= 'https://d30celkwnl03x3.cloudfront.net/blog/wp-content/uploads/2019/06/ezgif.com-gif-maker.gif?raw=true';
    }
    dressNotifier.add(dressCode, dressName, dressSize, dressPrice, dressColour, dressQuantity, tailoringTime,dressDescription,dressPhoto);
    // if(result!=0){
