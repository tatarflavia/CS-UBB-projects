...
class AddDressState extends State<AddDress>{
  ...
  void addButtonPressed(){
    int dressID=repository.getSize()+1;
    ...
    repository.addDress(new Dress(dressID, dressCode, dressName, dressSize, dressPrice, dressColour, dressQuantity, tailoringTime,dressDescription));
