...
//	WeddingDress dre2{ 40,"white",4000,50,"link2" };
...
//
//	WeddingDressValidator valid{};
//	Controller ctrl{ repo,basket, valid};
//	ctrl.add(38, "white", 6000, 30, "link1");
//	ctrl.add(40, "white", 4000, 50, "link2");
...
//	assert(vector.at(1).get_size()==40);
