...
public class AssignmentDBRepository implements SortingRepository<Pair<Long,Long>, Grade> {
    ...
    @Override
    public Optional<Grade> save(Grade entity) throws ServiceException {
        grades=new HashMap<>();
        this.loadGrades();
        ...
        previous.ifPresentOrElse(grade -> {}, ()->{
            ...
            catch (SQLException e){throw new ServiceException("There was a problem with adding data in the db!");}
        });
        return previous;
    }
    ...
    public Optional<Grade> delete(Pair<Long, Long> longLongPair) {
        ...
        previous.ifPresent(grade -> {
            ...
            catch (SQLException e){throw new ServiceException("There was a problem when deleting data from the database!");}
        });
        return previous;
    }
    ...
    @Override
    public Optional<Grade> update(Grade entity) throws ServiceException {
        grades=new HashMap<>();
        this.loadGrades();
        ...
        savedValue.ifPresent(grade -> {
            ...
            {throw new ServiceException("There was a problem when updating the database!");}
        });
        return savedValue;
    }
