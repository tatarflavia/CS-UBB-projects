...
public class AssignmentController {
    ...
    public List<GradeDto> getUngraded() {
        LOGGER.info("getUngraded method entered-server:");
        List<Grade> grades=gradeService.showAllUngraded();
        LOGGER.info("getUngraded method finished-server");
    ...
    public List<GradeDto> showAllGraded(){
        LOGGER.info("getGraded method entered-server:");
        List<Grade> grades=gradeService.showAllGraded();
        LOGGER.info("getGraded method finished-server");
        return new ArrayList<>(gradeConverter.convertModelsToDtos(grades));
    }

    @RequestMapping(value = "/grades", method = RequestMethod.GET)
    public List<GradeDto> getGrades(){
        LOGGER.info("getGrades method entered-server:");
        List<Grade> grades=gradeService.showAll();
        LOGGER.info("getGrades method finished-server");
        return new ArrayList<>(gradeConverter.convertModelsToDtos(grades));
    }
