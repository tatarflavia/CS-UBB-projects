...
public class StudentDBRepository implements SortingRepository<Long, Student> {
    ...
    public Iterable<Student> findAll(Sort sort) {
        students=new HashMap<>();
        this.loadStudents();
        return sort.sort(students.values().stream()
    ...
    @Override
    public Optional<Student> save(Student entity) throws RejectedInputException {
    ...
    @Override
    public Optional<Student> update(Student entity) throws RejectedInputException {
