...
public class ProblemDBRepository implements SortingRepository<Long, Problem> {
    ...
    public ProblemDBRepository() throws FileException {
        try{this.problems = new HashMap<>();
            ...
            throw new FileException("Could not connect to the database!AICI");}
        try {
            this.loadProblems();
    ...
    @Override
    public Optional<Problem> save(Problem entity) throws RejectedInputException {
    ...
    @Override
    public Optional<Problem> update(Problem entity) throws RejectedInputException {
